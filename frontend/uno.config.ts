...
export default defineConfig({
  ...
  shortcuts: [
    ...
    ['badge-doodle', 'inline-flex items-center gap-1 px-3 py-1 border-2 border-black bg-white text-black'],
    ['ds-card', 'bg-white ring-1 ring-stone-200 shadow-sm rounded-3xl'],
    ['ds-muted', 'text-stone-600'],
    ['ds-btn', 'inline-flex items-center justify-center font-900 rounded-2xl px-6 py-3 transition select-none'],
