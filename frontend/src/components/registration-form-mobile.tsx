...
const registrationSchema = z
  ...
  .refine(
    ...
    {
      message:
        "La fecha de salida debe ser posterior a la fecha de entrada (mínimo 1 noche)",
      path: ["checkOutDate"],
    },
  );
...
const steps = [
  {
    id: "dates",
    title: "Fechas",
    description: "Selecciona tu estancia",
    icon: Calendar,
  },
  {
    id: "personal",
  ...
  },
  {
    id: "documents",
    title: "Documentación",
    description: "Captura de documentos",
    icon: FileText,
  },
  {
    id: "payment",
        ...
        {steps.map((step, index) => (
          <div key={step.id} className="flex items-center min-w-0">
            ...
            {index < steps.length - 1 && (
              <div
                className={`w-8 sm:w-24 h-1 mx-1 sm:mx-2 ${index < currentStep ? "bg-primary" : "bg-muted"}`}
              />
            )}
          </div>
        ))}
              ...
              <div className="space-y-6">
                ...
                <Alert className="border-gray-200 bg-gray-50">
                  ...
                  <AlertDescription className="text-gray-700">
                    <strong>Disponibilidad confirmada</strong> - Hay camas
            ...
            {currentStep === 1 && (
              <div className="space-y-4">
                ...
                <p className="text-sm text-gray-600">
                  Formulario de información personal aquí...
                </p>
              </div>
            )}
