[Skip to main content](https://docs.projectdiscovery.io/opensource/katana/running#content-area)
...
- [Running Katana](https://docs.projectdiscovery.io/opensource/katana/running#running-katana)
- [Input for katana](https://docs.projectdiscovery.io/opensource/katana/running#input-for-katana)
- [URL Input](https://docs.projectdiscovery.io/opensource/katana/running#url-input)
- [Multiple URL Input (comma-separated)](https://docs.projectdiscovery.io/opensource/katana/running#multiple-url-input-comma-separated)
- [List Input](https://docs.projectdiscovery.io/opensource/katana/running#list-input)
- [STDIN (piped) Input](https://docs.projectdiscovery.io/opensource/katana/running#stdin-piped-input)
- [Crawling Mode](https://docs.projectdiscovery.io/opensource/katana/running#crawling-mode)
- [Standard Mode](https://docs.projectdiscovery.io/opensource/katana/running#standard-mode)
- [Headless Mode](https://docs.projectdiscovery.io/opensource/katana/running#headless-mode)
- [-no-sandbox](https://docs.projectdiscovery.io/opensource/katana/running#no-sandbox)
- [-no-incognito](https://docs.projectdiscovery.io/opensource/katana/running#no-incognito)
- [-headless-options](https://docs.projectdiscovery.io/opensource/katana/running#headless-options)
- [Scope Control](https://docs.projectdiscovery.io/opensource/katana/running#scope-control)
- [-field-scope](https://docs.projectdiscovery.io/opensource/katana/running#field-scope)
- [-crawl-scope](https://docs.projectdiscovery.io/opensource/katana/running#crawl-scope)
- [-crawl-out-scope](https://docs.projectdiscovery.io/opensource/katana/running#crawl-out-scope)
- [-no-scope](https://docs.projectdiscovery.io/opensource/katana/running#no-scope)
- [-display-out-scope](https://docs.projectdiscovery.io/opensource/katana/running#display-out-scope)
- [Crawler Configuration](https://docs.projectdiscovery.io/opensource/katana/running#crawler-configuration)
- [-depth](https://docs.projectdiscovery.io/opensource/katana/running#depth)
- [-js-crawl](https://docs.projectdiscovery.io/opensource/katana/running#js-crawl)
- [-crawl-duration](https://docs.projectdiscovery.io/opensource/katana/running#crawl-duration)
- [-known-files](https://docs.projectdiscovery.io/opensource/katana/running#known-files)
- [-automatic-form-fill](https://docs.projectdiscovery.io/opensource/katana/running#automatic-form-fill)
- [Authenticated Crawling](https://docs.projectdiscovery.io/opensource/katana/running#authenticated-crawling)
- [-headers](https://docs.projectdiscovery.io/opensource/katana/running#headers)
- [Connecting to Active Browser Session](https://docs.projectdiscovery.io/opensource/katana/running#connecting-to-active-browser-session)
- [Filters](https://docs.projectdiscovery.io/opensource/katana/running#filters)
- [-field](https://docs.projectdiscovery.io/opensource/katana/running#field)
- [Custom Fields](https://docs.projectdiscovery.io/opensource/katana/running#custom-fields)
- [Running katana using custom field:](https://docs.projectdiscovery.io/opensource/katana/running#running-katana-using-custom-field)
- [-store-field](https://docs.projectdiscovery.io/opensource/katana/running#store-field)
- [Katana Filters](https://docs.projectdiscovery.io/opensource/katana/running#katana-filters)
- [-extension-match](https://docs.projectdiscovery.io/opensource/katana/running#extension-match)
- [-extension-filter](https://docs.projectdiscovery.io/opensource/katana/running#extension-filter)
- [-match-regex](https://docs.projectdiscovery.io/opensource/katana/running#match-regex)
- [-filter-regex](https://docs.projectdiscovery.io/opensource/katana/running#filter-regex)
- [Advance Filtering](https://docs.projectdiscovery.io/opensource/katana/running#advance-filtering)
- [Rate Limit](https://docs.projectdiscovery.io/opensource/katana/running#rate-limit)
- [-delay](https://docs.projectdiscovery.io/opensource/katana/running#delay)
- [-concurrency](https://docs.projectdiscovery.io/opensource/katana/running#concurrency)
- [-parallelism](https://docs.projectdiscovery.io/opensource/katana/running#parallelism)
- [-rate-limit](https://docs.projectdiscovery.io/opensource/katana/running#rate-limit-2)
- [-rate-limit-minute](https://docs.projectdiscovery.io/opensource/katana/running#rate-limit-minute)
- [Output](https://docs.projectdiscovery.io/opensource/katana/running#output)
- [-output](https://docs.projectdiscovery.io/opensource/katana/running#output-2)
- [-jsonl](https://docs.projectdiscovery.io/opensource/katana/running#jsonl)
- [-store-response](https://docs.projectdiscovery.io/opensource/katana/running#store-response)
- [Katana as a library](https://docs.projectdiscovery.io/opensource/katana/running#katana-as-a-library)
...
For all of the flags and options available for Katana be sure to check out the [Usage](https://docs.projectdiscovery.io/opensource/katana/usage) page.On this page we share examples of Katana with specific flags and goals and the output you can expect from each.

If you have questions, reach out to us through [Help](https://docs.projectdiscovery.io/help).

## [​](https://docs.projectdiscovery.io/opensource/katana/running\#running-katana)  Running Katana

Katana requires a URL or endpoint to crawl and accepts single or multiple inputs.A URL can be provided using -u option, and multiple values can be provided using comma-separated input, similarly file input is supported using -list option and additionally piped input (stdin) is also supported.

### [​](https://docs.projectdiscovery.io/opensource/katana/running\#input-for-katana)  Input for katana
...
#### [​](https://docs.projectdiscovery.io/opensource/katana/running\#url-input)  URL Input

```
katana -u https://tesla.com
```

#### [​](https://docs.projectdiscovery.io/opensource/katana/running\#multiple-url-input-comma-separated)  Multiple URL Input (comma-separated)

```
katana -u https://tesla.com,https://google.com
```

#### [​](https://docs.projectdiscovery.io/opensource/katana/running\#list-input)  List Input
...
#### [​](https://docs.projectdiscovery.io/opensource/katana/running\#stdin-piped-input)  STDIN (piped) Input
...
## [​](https://docs.projectdiscovery.io/opensource/katana/running\#crawling-mode)  Crawling Mode

### [​](https://docs.projectdiscovery.io/opensource/katana/running\#standard-mode)  Standard Mode
...
### [​](https://docs.projectdiscovery.io/opensource/katana/running\#headless-mode)  Headless Mode
...
Headless crawling is optional and can be enabled using `-headless` option.Here are other headless CLI options -
...
### [​](https://docs.projectdiscovery.io/opensource/katana/running\#no-sandbox)  `-no-sandbox`
...
### [​](https://docs.projectdiscovery.io/opensource/katana/running\#no-incognito)  _`-no-incognito`_
...
### [​](https://docs.projectdiscovery.io/opensource/katana/running\#headless-options)  _`-headless-options`_
...
## [​](https://docs.projectdiscovery.io/opensource/katana/running\#scope-control)  Scope Control

Crawling can be endless if not scoped, as such katana comes with multiple support to define the crawl scope.

### [​](https://docs.projectdiscovery.io/opensource/katana/running\#field-scope)  _`-field-scope`_
...
### [​](https://docs.projectdiscovery.io/opensource/katana/running\#crawl-scope)  _`-crawl-scope`_
...
### [​](https://docs.projectdiscovery.io/opensource/katana/running\#crawl-out-scope)  _`-crawl-out-scope`_
...
### [​](https://docs.projectdiscovery.io/opensource/katana/running\#no-scope)  _`-no-scope`_
...
## [​](https://docs.projectdiscovery.io/opensource/katana/running\#display-out-scope)  _`-display-out-scope`_
...
## [​](https://docs.projectdiscovery.io/opensource/katana/running\#crawler-configuration)  Crawler Configuration

Katana comes with multiple options to configure and control the crawl as the way we want.

### [​](https://docs.projectdiscovery.io/opensource/katana/running\#depth)  _`-depth`_
...
### [​](https://docs.projectdiscovery.io/opensource/katana/running\#js-crawl)  _`-js-crawl`_
...
### [​](https://docs.projectdiscovery.io/opensource/katana/running\#crawl-duration)  _`-crawl-duration`_
...
### [​](https://docs.projectdiscovery.io/opensource/katana/running\#known-files)  _`-known-files`_
...
### [​](https://docs.projectdiscovery.io/opensource/katana/running\#automatic-form-fill)  _`-automatic-form-fill`_

* * *

Option to enable automatic form filling for known / unknown fields, known field values can be customized as needed by updating form config file at `$HOME/.config/katana/form-config.yaml`.Automatic form filling is experimental feature.

```
katana -u https://tesla.com -aff
```

## [​](https://docs.projectdiscovery.io/opensource/katana/running\#authenticated-crawling)  Authenticated Crawling
...
### [​](https://docs.projectdiscovery.io/opensource/katana/running\#headers)  _`-headers`_
...
## [​](https://docs.projectdiscovery.io/opensource/katana/running\#filters)  Filters

### [​](https://docs.projectdiscovery.io/opensource/katana/running\#field)  _`-field`_
...
### [​](https://docs.projectdiscovery.io/opensource/katana/running\#custom-fields)  Custom Fields
...
#### [​](https://docs.projectdiscovery.io/opensource/katana/running\#running-katana-using-custom-field)  Running katana using custom field:

```
katana -u https://tesla.com -f email,phone
```

## [​](https://docs.projectdiscovery.io/opensource/katana/running\#store-field)  _`-store-field`_
...
## [​](https://docs.projectdiscovery.io/opensource/katana/running\#katana-filters)  Katana Filters

### [​](https://docs.projectdiscovery.io/opensource/katana/running\#extension-match)  _`-extension-match`_
...
### [​](https://docs.projectdiscovery.io/opensource/katana/running\#extension-filter)  _`-extension-filter`_
...
### [​](https://docs.projectdiscovery.io/opensource/katana/running\#match-regex)  _`-match-regex`_
...
## [​](https://docs.projectdiscovery.io/opensource/katana/running\#filter-regex)  _`-filter-regex`_
...
### [​](https://docs.projectdiscovery.io/opensource/katana/running\#advance-filtering)  Advance Filtering
...
DSL functions can be applied to any keys in the jsonl output. For more information on available DSL functions, please visit the [dsl project](https://github.com/projectdiscovery/dsl).Here are additional filter options -
...
## [​](https://docs.projectdiscovery.io/opensource/katana/running\#rate-limit)  Rate Limit
...
### [​](https://docs.projectdiscovery.io/opensource/katana/running\#delay)  _`-delay`_
...
### [​](https://docs.projectdiscovery.io/opensource/katana/running\#concurrency)  _`-concurrency`_
...
### [​](https://docs.projectdiscovery.io/opensource/katana/running\#parallelism)  _`-parallelism`_
...
### [​](https://docs.projectdiscovery.io/opensource/katana/running\#rate-limit-2)  _`-rate-limit`_
...
### [​](https://docs.projectdiscovery.io/opensource/katana/running\#rate-limit-minute)  _`-rate-limit-minute`_
...
## [​](https://docs.projectdiscovery.io/opensource/katana/running\#output)  Output
...
### [​](https://docs.projectdiscovery.io/opensource/katana/running\#output-2)  _`-output`_
...
### [​](https://docs.projectdiscovery.io/opensource/katana/running\#jsonl)  _`-jsonl`_
...
### [​](https://docs.projectdiscovery.io/opensource/katana/running\#store-response)  _`-store-response`_
...
**Note:**_`-store-response` option is not supported in `-headless` mode._Here are additional CLI options related to output -
...
## [​](https://docs.projectdiscovery.io/opensource/katana/running\#katana-as-a-library)  Katana as a library
...
[Suggest edits](https://github.com/projectdiscovery/docs/edit/main/opensource/katana/running.mdx) [Raise issue](https://github.com/projectdiscovery/docs/issues/new?title=Issue%20on%20docs&body=Path:%20/opensource/katana/running)

[Usage](https://docs.projectdiscovery.io/opensource/katana/usage) [Overview](https://docs.projectdiscovery.io/opensource/naabu/overview)
