...
const translations = {
  ...
  "registration.contact_privacy_notice":
    "Tu información de contacto se utilizará únicamente para confirmar tu reserva y enviarte detalles importantes.",
