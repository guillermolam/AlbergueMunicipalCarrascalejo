    ...
    <div className="grid grid-cols-2 gap-4 p-4 bg-gray-50 rounded-lg">
      {Object.entries(bunks).map(([bunkNumber, bunkBeds]) => {
        ...
        return (
          <div
            key={bunkNumber}
            className="flex flex-col items-center space-y-1 p-2 bg-white rounded border"
          >
            ...
            <CardHeader>
              <CardTitle className="flex items-center gap-2">
                ...
                <Badge variant="secondary">
                  {roomBeds.filter((bed) => bed.isAvailable).length}/
                  {roomBeds.length} available
                </Badge>
              </CardTitle>
            </CardHeader>
            <CardContent>
          ...
          <CardContent className="pt-6">
            <div className="text-center">
              ...
              <p className="text-blue-800">
                ...
                {selectedBed.position === "top" ? "Top" : "Bottom"} Bed{" "}
