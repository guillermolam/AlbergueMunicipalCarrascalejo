...
describe("CountryPhoneInput Component", () => {
  ...
  describe("Full Mount Rendering", () => {
    ...
    it("should show country options in select", () => {
      const wrapper = renderWithProvider();
      expect(wrapper.find('[data-testid="mock-select-content"]')).toHaveLength(
        1,
      );
    });
  });
  ...
  describe("Phone Number Parsing", () => {
    it("should parse phone number with country code correctly", () => {
      const wrapper = shallow(
        <CountryPhoneInput value="+34666777888" onChange={jest.fn()} />,
      );
    ...
    it("should handle phone number without country code", () => {
      const wrapper = shallow(
        <CountryPhoneInput value="666777888" onChange={jest.fn()} />,
      );
    ...
    it("should handle different country codes", () => {
      ...
      testCases.forEach(({ value, expectedCode, expectedNumber }) => {
        const wrapper = shallow(
          <CountryPhoneInput value={value} onChange={jest.fn()} />,
        );
  ...
  describe("Country Selection", () => {
    ...
    it("should default to Spain (+34) when no country specified", () => {
      const wrapper = shallow(
        <CountryPhoneInput value="123456789" onChange={jest.fn()} />,
      );
  ...
  describe("Validation and Formatting", () => {
    it("should validate phone number format", () => {
      const validNumbers = ["+34666777888", "+33123456789", "+1234567890"];

      validNumbers.forEach((number) => {
        const wrapper = shallow(
          <CountryPhoneInput value={number} onChange={jest.fn()} />,
        );
        expect(wrapper.exists()).toBe(true);
      });
    });
    ...
    it("should handle malformed phone numbers gracefully", () => {
      const malformedNumbers = ["invalid", "++34123", "+", "34-666-777-888"];
  ...
  describe("Edge Cases", () => {
    it("should handle undefined value", () => {
      expect(() => {
        shallow(
          <CountryPhoneInput value={undefined as any} onChange={jest.fn()} />,
        );
      }).not.toThrow();
    });
    ...
    it("should handle very long phone numbers", () => {
      ...
      const wrapper = shallow(
        <CountryPhoneInput value={longNumber} onChange={jest.fn()} />,
      );
  ...
  describe("Component State Management", () => {
    it("should maintain internal state correctly", () => {
      const wrapper = shallow(
        <CountryPhoneInput value="+34123456789" onChange={jest.fn()} />,
      );
